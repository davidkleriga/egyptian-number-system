...
var _ = require('underscore'), express = require('express'), router = express.Router(), UnitFractionSummationConverter = require('../models/unit-fraction');
...
router.get('/unit-fraction-conversions/:numerator/:denominator', function (request, response) {
    ...
    if (rationalNumber.numerator && rationalNumber.denominator) {
        ...
        converter.fromRationalNumber(rationalNumber).then(function (unitFractionSummation) {
